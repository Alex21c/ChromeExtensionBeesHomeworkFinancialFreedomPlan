...
channel.onmessage = (msg) => {
  ...
  li.className="flex gap-[.5rem] text-[#ffd43b] font-semibold text-[1rem] items-center ";
  li.innerHTML =`
    <i class="fa-sharp fa-solid fa-circle-info text-[1.5rem]"></i>
    <span>${msg.data.status}</span>
  `;  
  // console.log(msg);
  ulInfoMsg.append(li);
//  console.log('message received from service worker', msg.status);
}
